...
const MAPLE_ASSET_PATHS = {
  ...
  mob_FAUST: '/data/maple/mob_FAUST.json',
  mob_STUMPY: '/data/maple/mob_STUMPY.json',
  mob_DYLE: '/data/maple/mob_DYLE.json',
  mob_SL: '/data/maple/mob_SL.json',
  mob_ST: '/data/maple/mob_ST.json',
  mob_GM: '/data/maple/mob_GM.json',
  mob_PG: '/data/maple/mob_PG.json',
  mob_CE: '/data/maple/mob_CE.json',
  mob_EE: '/data/maple/mob_EE.json',
  mob_JN: '/data/maple/mob_JN.json',
  mob_WM: '/data/maple/mob_WM.json',
  mob_WB: '/data/maple/mob_WB.json',
  mob_FB: '/data/maple/mob_FB.json',
  mob_SG: '/data/maple/mob_SG.json',
  mob_DS: '/data/maple/mob_DS.json',
  mob_OC: '/data/maple/mob_OC.json',
  mob_BB: '/data/maple/mob_BB.json',
  mob_LG: '/data/maple/mob_LG.json',
  mob_WK: '/data/maple/mob_WK.json',
  ...
  shoes_DARK: '/data/maple/shoes_DARK.json',
  weapon_DARK: '/data/maple/weapon_DARK.json',
  ...
  hair_NOVA: '/data/maple/hair_NOVA.json',
  coat_NOVA: '/data/maple/coat_NOVA.json',
  shoes_NOVA: '/data/maple/shoes_NOVA.json',
  weapon_NOVA: '/data/maple/weapon_NOVA.json',
  acc_NOVA: '/data/maple/acc_NOVA.json',
  acc_EARRING: '/data/maple/acc_EARRING.json',
  shoes_DRAKAZ: '/data/maple/shoes_DRAKAZ.json',
  hair_60000: '/data/maple/hair_60000.json',
  face_50247: '/data/maple/face_50247.json',
  acc_1012626: '/data/maple/acc_1012626.json',
  // Cosmetic items
