...
import { toSX, toSY, P, enemies, projs, novas, clouds, hawks, meteors, lightnings, drops, parts, ftexts, gTimer, camX, camY, shakeX, shakeY, awakenT, awakenName, hurtT, cosmeticCapAssetKey, cosmeticCapVslot, currentDifficultyMult, currentBgTheme, drawCosmeticOverlay } from './engine';
